          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group cursor-pointer rounded-xl border border-border/60 bg-white dark:bg-surface/30 hover:shadow-lg dark:hover:border-primary/40 transition-all overflow-hidden shadow-sm">
              <div className="h-44 bg-slate-300/80 dark:bg-black/40 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4 scale-75 origin-top-left opacity-80">
                  <div className="bg-muted/5 dark:bg-muted/20 backdrop-blur-sm rounded-full px-3 py-1 text-[10px] mb-2 font-medium">How are you?</div>
                  <div className="bg-primary/10 dark:bg-blue-600/30 backdrop-blur-sm rounded-full px-3 py-1 text-[10px] text-white">Hello, how are you?</div>
                </div>
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 scale-75">
                  <div className="w-8 h-8 rounded-full bg-muted/5 dark:bg-muted/20 backdrop-blur-sm flex items-center justify-center shadow-sm"><Monitor className="w-4 h-4 text-white dark:text-white/60" /></div>
                  <div className="w-8 h-8 rounded-full bg-muted/5 dark:bg-muted/20 backdrop-blur-sm flex items-center justify-center shadow-sm"><Users className="w-4 h-4 text-white dark:text-white/60" /></div>
                </div>
              </div>
              <div className="p-5">
            ...
            <div className="group cursor-pointer rounded-xl border border-border/60 bg-white dark:bg-surface/30 hover:shadow-lg dark:hover:border-primary/40 transition-all overflow-hidden shadow-sm">
              <div className="h-44 bg-slate-300/80 dark:bg-black/40 flex items-center justify-center relative p-6">
                <div className="w-full h-full border border-border/40 rounded-md bg-muted/5 backdrop-blur-sm flex gap-2 p-2 shadow-sm">
                  <div className="flex-1 bg-muted/5 rounded flex items-center justify-center">
                  ...
                  <div className="w-12 flex flex-col gap-2">
                    ...
                    <div className="h-10 border border-border/40 rounded bg-muted/10" />
                    <div className="h-10 bg-muted/10 rounded" />
                  </div>
                </div>
              </div>

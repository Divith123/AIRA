            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-surface-hover/30">
                  ...
                  <th className="text-left px-6 py-3 text-secondary text-[11px] font-semibold uppercase tracking-wider">Sessions</th>
                </tr>
              </thead>
              <tbody>
                <tr>

    ...
    return (
        <div className="p-6 rounded-lg bg-gradient-to-br from-surface to-surface-hover border border-white/[0.06] mb-6">
            <div className="flex items-start justify-between">
                <div>
                    <h2 className="text-xl font-semibold text-foreground mb-2">Welcome to Relatim Cloud</h2>
                    <p className="text-secondary text-sm max-w-lg mb-6">
                        Get started by creating your first agent, or explore our documentation to learn more about what you can build.
                    </p>
